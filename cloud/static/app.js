...
for (var i = 0; i < tonItems.length; i++) {
    ...
    item.style.background = `rgb(${88-(i*6)}, ${96-(i*6.57)}, ${103-(i*7)}, 0.5)`
}

// Change the font size of each ton item from 3vh to 10 (with 8 steps)
// Change the background color from rgb(46, 50, 54, 0.6) to rgb(0, 0, 0, 0.5)
...
for (var i = 0; i < millTonItems.length; i++) {
    ...
    item.style.background = `rgb(${46-(i*5.75)}, ${50-(i*6.25)}, ${54-(i*6.75)}, 0.5)`
